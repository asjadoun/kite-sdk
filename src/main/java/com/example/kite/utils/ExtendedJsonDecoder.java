...
//    private ExtendedJsonDecoder(Symbol root, InputStream in) throws IOException {
//        super(root);
//        configure(in);
//    }

//    private ExtendedJsonDecoder(Symbol root, String in) throws IOException {
//        super(root);
//        configure(in);
//    }
...
//        this(getSymbol(schema), in);
    ...
    public int readIndex() throws IOException {
        ...
        if (in.getCurrentToken() == JsonToken.VALUE_NULL) {
            ...
            int nullIdx = a.findLabel("null");
            int maxIdx = a.size() - 1;
            label = (nullIdx == maxIdx) ? a.getLabel(maxIdx - 1) : a.getLabel(maxIdx);
        } else {
